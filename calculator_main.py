...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        layout_equation_solution.addWidget(self.equation, 0, 1)
        layout_equation_solution.addWidget(label_solution, 1, 0)
        layout_equation_solution.addWidget(self.solution, 1, 1)
        ...
        layout_clear_equal.addWidget(button_backspace, 0, 2)
        layout_clear_equal.addWidget(button_equal, 0, 3)
        ...
        main_layout.addLayout(layout_operation, 0, 1)
